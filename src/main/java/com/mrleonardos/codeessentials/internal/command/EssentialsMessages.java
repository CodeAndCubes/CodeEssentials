...
public final class EssentialsMessages {
    ...
    public static final String USAGE_KIT = "codeessentials.command.usage.kit";
    public static final String USAGE_KITS = "codeessentials.command.usage.kits";
    ...
    public static final String ERROR_KIT_DENIED = "codeessentials.error.kit_denied";
    ...
    public static final String KITS = "codeessentials.message.kits";
    public static final String KITS_EMPTY = "codeessentials.message.kits_empty";
    public static final String KITS_LINE_READY = "codeessentials.message.kits_line_ready";
    public static final String KITS_LINE_WAIT = "codeessentials.message.kits_line_wait";
    public static final String KITS_LINE_TAKEN = "codeessentials.message.kits_line_taken";
    public static final String KITS_LINE_BUFFERED = "codeessentials.message.kits_line_buffered";
    public static final String KITS_LINE_READY_LOCKED = "codeessentials.message.kits_line_ready_locked";
    public static final String KITS_LINE_WAIT_LOCKED = "codeessentials.message.kits_line_wait_locked";
    public static final String KITS_LINE_TAKEN_LOCKED = "codeessentials.message.kits_line_taken_locked";
    public static final String KITS_LINE_BUFFERED_LOCKED = "codeessentials.message.kits_line_buffered_locked";
    public static final String KIT_CLAIMED = "codeessentials.message.kit_claimed";
    public static final String KIT_OVERFLOW = "codeessentials.message.kit_overflow";
    public static final String KIT_STASHED = "codeessentials.message.kit_stashed";
    public static final String KIT_DEBT = "codeessentials.message.kit_debt";
    public static final String KIT_GIVEN = "codeessentials.message.kit_given";
    public static final String KIT_PENDING = "codeessentials.message.kit_pending";
